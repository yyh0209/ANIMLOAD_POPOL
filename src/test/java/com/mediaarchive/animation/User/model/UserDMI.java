...
public class UserDMI extends UserVO {
	...
	private List<GalleryRecPicsVO> gallert_List; //메뉴들
	...
	public List<GalleryRecPicsVO> getGallert_List() {
		return gallert_List;
	}
	public void setGallert_List(List<GalleryRecPicsVO> gallert_List) {
		this.gallert_List = gallert_List;
	}
}	
